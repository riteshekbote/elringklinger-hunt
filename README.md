...
24/7 deep multi-model bug-hunting automation for **ElringKlinger AG** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, services, domains, applications, and systems including subsidiaries and brands of ElringKlinger Group
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/elringklinger.md` and
...
Program description: German global automotive supplier specializing in e-mobility, sealing systems, lightweight components, and fuel cell technology
